...
const static PB_IO_PIN_TYPE PB_OUTPUT_TABLE[PB_OUT_END] = 
{
    ...
    {BOARD_OUT_VENDING_MACHINE},    {BOARD_OUT_EMERGENCY_LIGHT},    {BOARD_OUT_AIR_PURGE},  {BOARD_OUT_OUTDOOR_LIGHTBOX},
    {BOARD_OUT_ADV_MACHINE1},         {BOARD_OUT_ADV_MACHINE2},         {BOARD_OUT_RESERVED18},    {BOARD_OUT_RESERVED19},
