...
#define BOARD_BKP_ORDER_EXPIRE_CRC_ADDR BKP_DR4
#define BOARD_BKP_ORDER_EXPIREH_ADDR BKP_DR5
#define BOARD_BKP_ORDER_EXPIREL_ADDR BKP_DR6
...
#define BOARD_OUT_AIR_PURGE GPIOF, GPIO_Pin_7
#define BOARD_OUT_OUTDOOR_LIGHTBOX GPIOF, GPIO_Pin_6
#define BOARD_OUT_ADV_MACHINE1 GPIOF, GPIO_Pin_5
#define BOARD_OUT_ADV_MACHINE2 GPIOF, GPIO_Pin_4
