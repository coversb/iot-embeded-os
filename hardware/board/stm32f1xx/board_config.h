...
//PAM8610
#define BOARD_PA_IO_RCC RCC_APB2Periph_GPIOE
#define BOARD_PA_PWR GPIOE, GPIO_Pin_0
//KT603C
#define BOARD_KT603_IO_RCC RCC_APB2Periph_GPIOA
#define BOARD_KT603_RST GPIOA, GPIO_Pin_1
#define BOARD_KT603_DEBUG 1
...
/*emergency button*/
#define BOARD_EMERGENCY_BTN_RCC RCC_APB2Periph_GPIOD
#define BOARD_EMERGENCY_BTN GPIOD, GPIO_Pin_1
