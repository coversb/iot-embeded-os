...
#define BOARD_BKP_ORDER_EXPIRE_CRC_ADDR RTC_BKP_DR3
#define BOARD_BKP_ORDER_EXPIRE_ADDR RTC_BKP_DR4
...
#define BOARD_OUT_AIR_PURGE GPIOF, GPIO_Pin_2
#define BOARD_OUT_OUTDOOR_LIGHTBOX GPIOF, GPIO_Pin_3
#define BOARD_OUT_ADV_MACHINE1 GPIOF, GPIO_Pin_4
#define BOARD_OUT_ADV_MACHINE2 GPIOF, GPIO_Pin_5
